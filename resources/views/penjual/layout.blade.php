        ...
        <div class="col-2 bg-info text-white shadow d-none d-lg-block">
            <div class="py-4">
                <ul class="fw-bold p-2">
                    ...
                    <a href="/datamenu" class="text-decoration-none text-white">
                        <li class="list-unstyled fs-5 mb-3"><i class="fa-solid fa-bowl-food me-1"></i> Data Menu</li>
                    </a>

                    <a href="/datatransaksi" class="text-decoration-none text-white">
                        <li class="list-unstyled fs-5 mb-3"><i class="fa-solid fa-money-bill-transfer"></i> Data Transaksi</li>
                    </a>

                    <a href="/datapesanan" class="text-decoration-none text-white">
                        <li class="list-unstyled fs-5 mb-3"><i class="fa-solid fa-receipt me-2"></i> Data Pesanan</li>
                    </a>
